...
<html>
<title>Edit Quality</title>
</html>



<div class="container-fluid px-4">
    <h1 class="mt-4"> Edit quality ${hardwareQuality.name}:</h1>
...
<form:form action="/hardwareQuality/edit" method="post" modelAttribute="hardwareQuality">
    <form:hidden path="id"/>
    <div>
        <label>Name</label>
