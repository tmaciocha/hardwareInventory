...
<div class="container-fluid px-4">
    <h1 class="mt-4"> Add task for
        </br>Serial: ${hardware.get().serialNumber}, ${hardware.get().producer.name} ${hardware.get().name}, user: ${hardware.get().user.username} </h1>
    <ol class="breadcrumb mb-4">
    </ol>


    Hardware id: ${hardwareId}
    <form:form method="post" modelAttribute="task" action="/task/add/hardware/${hardwareId}">
        <form:hidden path="id"/>
